            ...
            <div className="md:flex justify-center items-center">
                ...
                <div className="card flex-shrink-0 w-full max-w-sm">
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        <h1 className="text-2xl text-center font-bold">Please Registration!</h1>
                    ...
                    <h1 className='text-center'>Have an Account? Please <a className='text-orange-500'><Link to="/login">Login</Link></a></h1>
                </div>
            </div>
        </div>
    );
